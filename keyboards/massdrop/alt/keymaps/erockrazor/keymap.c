...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LT(3,KC_GRAVE),KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  _______, _______,  \
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC, KC_DEL, KC_BSLS, KC_HOME, \
    KC_ESC,KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_PGUP, \
KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MO(4),          KC_UP,   KC_PGDN, \
        KC_LCTL, KC_LGUI, KC_LALT,                          LT(2,KC_SPC),                             KC_RALT, MO(1),   KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
    ...
    [2] = LAYOUT_65_ansi_blocker(
        ...
        _______,KC_LEFT_PAREN,KC_RIGHT_PAREN,KC_LBRC,KC_RBRC, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END, _______, _______, _______, _______, _______, \
        _______, KC_EQL, KC_SLSH, KC_LCBR, KC_RCBR, _______,    KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, _______, _______,           _______, _______, \
        _______, KC_UNDS, KC_MINS, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, \
   ...
   _______,KC_MS_BTN1,KC_MS_BTN2, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
    ...
    [4] = LAYOUT_65_ansi_blocker(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
        _______,KC_LEFT_PAREN,KC_RIGHT_PAREN,KC_LBRC,KC_RBRC,_______,_______, _______, _______, _______, _______,  _______, _______, _______, _______, \
        _______, KC_EQL, _______, KC_LCBR, KC_RCBR, _______, _______, _______, _______, _______, _______, _______,          _______, _______, \
        _______, KC_UNDS, KC_MINS, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, \
        _______, _______, _______,                            _______,                            _______, _______, _______, _______, _______  \
    ),
};
